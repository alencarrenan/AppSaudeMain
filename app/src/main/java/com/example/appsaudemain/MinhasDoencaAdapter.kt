...
class MinhasDoencasAdapter(
    private val listaDoencas: List<Doenca>
) : RecyclerView.Adapter<MinhasDoencasAdapter.DoencaViewHolder>() {
    ...
    override fun getItemCount(): Int = listaDoencas.size

    override fun onBindViewHolder(holder: DoencaViewHolder, position: Int) {
        val doenca = listaDoencas[position]
